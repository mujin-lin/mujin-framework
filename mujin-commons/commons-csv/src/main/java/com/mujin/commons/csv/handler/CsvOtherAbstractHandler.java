...
/**
 * 其他类型handler抽象类，抽象的目的是为了兼容reader和writer的getHandlerType
 * @author chenglin.wu
 */
public abstract class CsvOtherAbstractHandler implements CsvReadHandler, CsvWriteHandler {

    @Override
    public CsvHandlerEnum getHandlerType() {
        return CsvHandlerEnum.OTHER;
    }
